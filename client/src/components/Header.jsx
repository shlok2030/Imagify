...
const Header = () => {
  ...
  return (
    ...
    text-center my-20'>
      ...
      <p className='text-center max-w-xl mx-auto mt-5'>Unleash your creativity with our AI-powered image generator.</p>
      ...
      <div className='flex flex-wrap justify-center mt-16 gap-3'>
        {Array(6).fill('').map((item, index) => (
          ...
          key={index} src={index % 2 === 0 ? assets.sample_img_1 : assets.sample_img_2} alt='' width={70}/>
        )) }
      </div>
